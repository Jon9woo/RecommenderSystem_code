...
SVD = SVD_PP(R_temp, K=230, alpha=0.001, beta=0.04, lamda=0.0017, iterations=500, tolerance=0.0001, verbose=True)
test_set = SVD.set_test(ratings_test)
result = SVD.test()

# Printing predictions
print(SVD.get_one_prediction(1, 2), ratings_test.loc[1][2])
